...
extern VAR(EBC2_SigStatusType, RTE_VAR_INIT_NOCACHE) Rte_Rx_SigStat_Arr_EBC2_oRx_SigStat_Arr_EBC2;
extern VAR(EEC2_SigStatusType, RTE_VAR_INIT_NOCACHE) Rte_Rx_SigStat_Arr_EEC2_oRx_SigStat_Arr_EEC2;
extern VAR(EPB1_SigStatusType, RTE_VAR_INIT_NOCACHE) Rte_Rx_SigStat_Arr_EPB1_oRx_SigStat_Arr_EPB1;
extern VAR(EPS2_SigStatusType, RTE_VAR_INIT_NOCACHE) Rte_Rx_SigStat_Arr_EPS2_oRx_SigStat_Arr_EPS2;
extern VAR(ETC2_SigStatusType, RTE_VAR_INIT_NOCACHE) Rte_Rx_SigStat_Arr_ETC2_oRx_SigStat_Arr_ETC2;
extern VAR(LC_SigStatusType, RTE_VAR_INIT_NOCACHE) Rte_Rx_SigStat_Arr_LC_oRx_SigStat_Arr_LC;
extern VAR(MCU1_SigStatusType, RTE_VAR_INIT_NOCACHE) Rte_Rx_SigStat_Arr_MCU1_oRx_SigStat_Arr_MCU1;
extern VAR(PS1_SigStatusType, RTE_VAR_INIT_NOCACHE) Rte_Rx_SigStat_Arr_PS1_oRx_SigStat_Arr_PS1;
extern VAR(VCU_Status_SigStatusType, RTE_VAR_INIT_NOCACHE) Rte_Rx_SigStat_Arr_VCU_Status_oRx_SigStat_Arr_VCU_Status;
extern VAR(VDC2_SigStatusType, RTE_VAR_INIT_NOCACHE) Rte_Rx_SigStat_Arr_VDC2_oRx_SigStat_Arr_VDC2;
extern VAR(uint64, RTE_VAR_INIT_NOCACHE) Rte_Rx_Time_Arr_CCVS1_oRx_Time_Arr_CCVS1;
extern VAR(uint64, RTE_VAR_INIT_NOCACHE) Rte_Rx_Time_Arr_EBC1_oRx_Time_Arr_EBC1;
extern VAR(uint64, RTE_VAR_INIT_NOCACHE) Rte_Rx_Time_Arr_EBC2_oRx_Time_Arr_EBC2;
extern VAR(uint64, RTE_VAR_INIT_NOCACHE) Rte_Rx_Time_Arr_EEC2_oRx_Time_Arr_EEC2;
extern VAR(uint64, RTE_VAR_INIT_NOCACHE) Rte_Rx_Time_Arr_EPB1_oRx_Time_Arr_EPB1;
extern VAR(uint64, RTE_VAR_INIT_NOCACHE) Rte_Rx_Time_Arr_EPS2_oRx_Time_Arr_EPS2;
extern VAR(uint64, RTE_VAR_INIT_NOCACHE) Rte_Rx_Time_Arr_ETC2_oRx_Time_Arr_ETC2;
extern VAR(uint64, RTE_VAR_INIT_NOCACHE) Rte_Rx_Time_Arr_LC_oRx_Time_Arr_LC;
extern VAR(uint64, RTE_VAR_INIT_NOCACHE) Rte_Rx_Time_Arr_MCU1_oRx_Time_Arr_MCU1;
extern VAR(uint64, RTE_VAR_INIT_NOCACHE) Rte_Rx_Time_Arr_PS1_oRx_Time_Arr_PS1;
extern VAR(uint64, RTE_VAR_INIT_NOCACHE) Rte_Rx_Time_Arr_VCU_Status_oRx_Time_Arr_VCU_Status;
extern VAR(uint64, RTE_VAR_INIT_NOCACHE) Rte_Rx_Time_Arr_VDC2_oRx_Time_Arr_VDC2;
extern VAR(rt_Array_uint8_6876, RTE_VAR_INIT_NOCACHE) Rte_ARS408_Info_ETH_oARS408_Info_ETH;
extern VAR(boolean, RTE_VAR_INIT_NOCACHE) Rte_ARS408_ETH_Tx_Flag_oARS408_ETH_Tx_Flag;
extern VAR(rt_Array_uint8_5192, RTE_VAR_INIT_NOCACHE) Rte_ARS430_Info_ETH_oARS430_Info_ETH;
extern VAR(boolean, RTE_VAR_INIT_NOCACHE) Rte_ARS430_ETH_Tx_Flag_oARS430_ETH_Tx_Flag;
extern VAR(rt_Array_uint8_224, RTE_VAR_INIT_NOCACHE) Rte_GNSS_Info_ETH_oGNSS_Info_ETH;
extern VAR(boolean, RTE_VAR_INIT_NOCACHE) Rte_GNSS_ETH_Tx_Flag_oGNSS_ETH_Tx_Flag;
extern VAR(RxSocAdminDataType, RTE_VAR_NOINIT_NOCACHE) Rte_RxSocAdminData_oRxSocAdminData;
extern VAR(TxSocAdminDataType, RTE_VAR_NOINIT_NOCACHE) Rte_TxSocAdminData_oTxSocAdminData;
extern VAR(uint8, RTE_VAR_INIT_NOCACHE) Rte_Rx_Pro_Cnt_LC_oRx_Pro_Cnt_LC;
extern VAR(uint8, RTE_VAR_INIT_NOCACHE) Rte_Rx_Cur_Pro_Cnt_LC_oRx_Cur_Pro_Cnt_LC;
extern VAR(rt_Array_uint8_208, RTE_VAR_INIT_NOCACHE) Rte_Cgi610_1_Data_oCgi610_1_Data;
extern VAR(rt_Array_uint8_208, RTE_VAR_INIT_NOCACHE) Rte_Cgi610_2_Data_oCgi610_2_Data;
extern VAR(rt_Array_uint8_208, RTE_VAR_INIT_NOCACHE) Rte_Cgi610_3_Data_oCgi610_3_Data;
extern VAR(rt_Array_uint8_208, RTE_VAR_INIT_NOCACHE) Rte_Cgi610_4_Data_oCgi610_4_Data;
extern VAR(rt_Array_uint8_208, RTE_VAR_INIT_NOCACHE) Rte_Cgi610_5_Data_oCgi610_5_Data;
extern VAR(rt_Array_uint8_128, RTE_VAR_INIT_NOCACHE) Rte_Orin0RxData_oOrin0RxData;
extern VAR(rt_Array_uint8_128, RTE_VAR_INIT_NOCACHE) Rte_Orin1RxData_oOrin1RxData;
extern VAR(rt_Array_uint8_128, RTE_VAR_INIT_NOCACHE) Rte_Orin2RxData_oOrin2RxData;
extern VAR(rt_Array_uint8_128, RTE_VAR_INIT_NOCACHE) Rte_Orin3RxData_oOrin3RxData;
extern VAR(rt_Array_uint8_12, RTE_VAR_INIT_NOCACHE) Rte_Core2TimeStamp_oCore2TimeStamp;
extern VAR(rt_Array_uint8_12, RTE_VAR_INIT_NOCACHE) Rte_Core0TimeStamp_oCore0TimeStamp;
extern VAR(rt_Array_uint8_12, RTE_VAR_INIT_NOCACHE) Rte_Core3TimeStamp_oCore3TimeStamp;
extern VAR(rt_Array_uint8_12, RTE_VAR_INIT_NOCACHE) Rte_Core5TimeStamp_oCore5TimeStamp;
extern VAR(rt_Array_uint8_200, RTE_VAR_INIT_NOCACHE) Rte_PpsStatus_oPpsStatus;
extern VAR(rt_Array_uint8_1024, RTE_VAR_INIT_NOCACHE) Rte_PowerMngComData_oPowerMngComData;
#endif