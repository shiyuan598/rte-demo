...
extern VAR(ADMInfoSOC2MCU, RTE_VAR_INIT_NOCACHE) Rte_ADMInfoSOC2MCU_oADMInfoSOC2MCU;
extern VAR(ChassisInfo, RTE_VAR_INIT_NOCACHE) Rte_ChassisInp_oChassisInp;
extern VAR(J6L_RxBus, RTE_VAR_INIT_NOCACHE) Rte_J6LCANRxInp_oJ6LCANRxInp;
extern VAR(PlanningInfo, RTE_VAR_INIT_NOCACHE) Rte_PlanningInfo_oPlanningInfo;
extern VAR(ChassisInfo, RTE_VAR_INIT_NOCACHE) Rte_ChassisInp_oChassisInp;
extern VAR(LocalizationInfo, RTE_VAR_INIT_NOCACHE) Rte_LocalizationInfo_oLocalizationInfo;
extern VAR(PlanningInfo, RTE_VAR_INIT_NOCACHE) Rte_PlanningInfo_oPlanningInfo;
extern VAR(PlanningInfo, RTE_VAR_INIT_NOCACHE) Rte_PlanningInfo_oPlanningInfo;
extern VAR(J6L_TxBus, RTE_VAR_INIT_NOCACHE) Rte_J6LCANTxOutp_oJ6LCANTxOutp;
extern VAR(ADMInfoMCU2SOC, RTE_VAR_INIT_NOCACHE) Rte_ADMInfoMCU2SOC_oADMInfoMCU2SOC;
extern VAR(CtrlInfoMCU2SOC, RTE_VAR_INIT_NOCACHE) Rte_CtrlDebugInfoMCU2SOC_oCtrlDebugInfoMCU2SOC;
